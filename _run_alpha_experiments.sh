...
python alpha_experiment_kmeans.py --err 0.1 --numIter $iter --dataset 20newsgroups --k $k --overwrite
python alpha_experiment_kmeans.py --err 0.2 --numIter $iter --dataset 20newsgroups --k $k
python alpha_experiment_kmeans.py --err 0.3 --numIter $iter --dataset 20newsgroups --k $k
python alpha_experiment_kmeans.py --err 0.4 --numIter $iter --dataset 20newsgroups --k $k
python alpha_experiment_kmeans.py --err 0.5 --numIter $iter --dataset 20newsgroups --k $k
